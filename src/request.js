    ...
    getHomeList: async () => { 
        return [
    ...
    
            {
                slug: 'action',
                title: 'Action',
                items: await simpleFetch(`discover/movie?with_geners=288&api_key=${API_key}`) 
            },
    
            {
                slug: 'comedy',
                title: 'Comedy',
                items: await simpleFetch(`discover/movie?with_geners=35&api_key=${API_key}`) 
            },
    
            {
                slug: 'horror',
                title: 'Horror',
                items: await simpleFetch(`discover/movie?with_geners=27&api_key=${API_key}`) 
            },
    
            {
                slug: 'romance',
                title: 'Romance',
                items: await simpleFetch(`discover/movie?with_geners=10749&api_key=${API_key}`) 
            },
